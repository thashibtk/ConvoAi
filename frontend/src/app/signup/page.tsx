  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 sm:p-8 relative">
      ...
      <div className="w-full max-w-md mt-12">
        <div className="brutal-card brutal-shadow w-full p-8 sm:p-10 bg-brutal-cyan relative mt-8">
        ...
        <h1 className="text-4xl sm:text-5xl font-black mb-2 uppercase tracking-tight text-center pt-6">Sign Up</h1>
        <p className="font-bold mb-8 text-lg text-center">Join ConvoAi today</p>
        ...
        {success && (
          <div className="bg-brutal-green text-black p-4 font-bold brutal-border mb-6">
            {success}
          </div>
        )}
        ...
        <form onSubmit={handleSignUp} className="space-y-6">
          <div>
            ...
            <input 
              ...
              className="w-full brutal-border p-3 text-lg focus:outline-none focus:bg-brutal-yellow transition-colors"
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="brutal-btn w-full bg-brutal-pink text-white hover:bg-black text-xl py-4"
          >
        ...
        <div className="mt-6">
          <button 
            ...
            type="button"
            className="brutal-btn w-full bg-white text-black hover:bg-brutal-yellow text-lg py-3 flex items-center justify-center gap-3"
          >
        ...
        <p className="mt-8 text-center font-bold">
          ALREADY REGISTERED? <Link href="/login" className="text-brutal-blue hover:underline bg-white px-2">LOGIN</Link>
        </p>
      </div>
      </div>
    </div>
