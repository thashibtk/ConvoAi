  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 sm:p-8 gap-6">
      <div className="w-full max-w-sm">
        ...
        <div className="brutal-card brutal-shadow w-full p-6 sm:p-8 bg-brutal-cyan">
          ...
          <h1 className="text-3xl sm:text-4xl font-black mb-1.5 uppercase tracking-tight text-center">Sign Up</h1>
          <p className="font-bold mb-7 text-base text-center text-black/70">Join ConvoAi today</p>
          ...
          {success && (
            <div className="bg-brutal-green text-black p-3.5 font-bold text-sm brutal-border mb-5 flex items-start gap-2.5">
          ...
          <form onSubmit={handleSignUp} className="space-y-5">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-black/60 mt-1.5">At least 6 characters.</p>
            </div>
            <button
              type="submit"
              disabled={loading}
              className="brutal-btn w-full bg-brutal-pink text-white hover:bg-black text-lg py-3.5 disabled:opacity-60 flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
          ...
          <button
            ...
            type="button"
            className="brutal-btn w-full bg-white text-black hover:bg-brutal-yellow text-base py-3 flex items-center justify-center gap-3"
          >
          ...
          <p className="mt-6 text-center font-bold text-sm">
            Already registered?{' '}
            <Link href="/login" className="text-brutal-blue hover:underline">
              Login
            </Link>
          </p>
        </div>
